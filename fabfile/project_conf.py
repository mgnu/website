...
fabconf['APPS_DIR'] = "/home/%s/django" % fabconf['SERVER_USERNAME']
...
# App domains
fabconf['DOMAINS'] = "site.org www.site.org"
...
fabconf['BITBUCKET_DEPLOY_KEY_NAME'] = ""
...
fabconf['BITBUCKET_TEAM_NAME'] = ''

# Creates the ssh location of your bitbucket repo from the above details
fabconf['BITBUCKET_REPO'] = "ssh://git@bitbucket.org/%s/%s.git" % (fabconf['BITBUCKET_TEAM_NAME'], fabconf['BITBUCKET_REPO_NAME'])
